<nav class="navbar navbar-expand-lg navbar-dark bg-transparent py-3 floating-nav wow slideInDown" data-wow-duration="1.2s" data-wow-delay="0.2s" id="mainNav">
  <div class="container py-2">
    <a class="navbar-brand font-weight-bold" href="#inicio">
      <img src="img/img-logocap.png" alt="Capacitación USACH" class="d-inline-block align-top" style="height: 40px;">
    </a>
